...
export const contactNameInput = {
  ...
  registerEventListeners() {
    contactNameInput.inputElm.onkeyup = (e) =>
      contactNameInput.reformat(e.target.value);
    contactNameInput.inputElm.onchange = (e) =>
      contactNameInput.set(e.target.value.trim());
  },
};
